...
import com.michjony.basic.thinkingjava.serializable.v2.Person;
...
public class SerTest2 {
	...
	public void serializeFromDisk() {
		try {
			...
			com.michjony.basic.thinkingjava.serializable.v2.Person ted = (com.michjony.basic.thinkingjava.serializable.v2.Person) ois
					.readObject();
			ois.close();
